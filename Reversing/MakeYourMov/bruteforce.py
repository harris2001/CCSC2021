...
for i in string.printable:
	...
	k=15
	print('''enc_str : [0x014,0x088,0x058,0x144,0x090,0x09c,0x14c,0x0c8,0x0b8,0x084,0x0ba,0x070,0x0a6,0x024,0x064,0x04a,0x04e,0x05a,0x070,0x01a,0x010,0x056,0x01b,0x035,0x021,0x03e,0x009,0x03d,0x021,0x026]
'''+"str : [0x43,0x53,0x43,0x43,0x7b,0x34,0x53,0x33,0x4d,0x62,0x6c,0x59,0x5f,0x4c,0x34,0x4e,0x47,0x73,0x5f,0x34,0x52,0x5f,0x48,0x34,0x72,0x64,0x5f,0x41,0x46,0x7d] //redacted"+
'''
...
_main:  t,t,str(1);
        ...
        loop: Z,Z,Z,loop;                   //END''')
	sys.stdout.close()
	os.system("python3 SLXS-processor/tool/slxs.py -i test.txt -f -s -u")
	os.system("cat output_files/simulator_output.txt |awk -F: 'FNR=="+str(k)+"{print$1}'")